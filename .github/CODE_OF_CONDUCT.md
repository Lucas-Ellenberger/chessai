# Chessai Code of Conduct

*This document outlines the general principles that one should follow when participating in any event/space that Chessai manages.*
