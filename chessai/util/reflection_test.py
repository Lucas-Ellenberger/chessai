...
class ReflectionTest(edq.testing.unittest.BaseTest):
    ...
    def test_class_reference_base(self):
        ...
        test_cases = [
            ...
            (
                'chessai.util.reflection.Reference',
                None,
                (None, 'chessai.util.reflection', 'Reference'),
            ),
            (
                'chessai/util/reflection.py:Reference',
                None,
                ('chessai/util/reflection.py', None, 'Reference'),
            ),
            (
                chessai.util.reflection.Reference('chessai.util.reflection.Reference'),
                None,
                (None, 'chessai.util.reflection', 'Reference'),
            ),
            ...
            (
                'agent-random',
                None,
                (None, 'chessai.agents.random', 'RandomAgent'),
            ),
            ...
            (
                r'chessai\util\reflection.py:Reference',
                None,
                (r'chessai\util\reflection.py', None, 'Reference'),
            ),
            (
                r'C:\chessai\util\reflection.py:Reference',
                None,
                (r'C:\chessai\util\reflection.py', None, 'Reference'),
            ),
            ...
            (
                'chessai/util/reflection.py:chessai.util.reflection.Reference',
        ...
        for (i, test_case) in enumerate(test_cases):
            ...
            with self.subTest(msg = f"Case {i}:"):
                try:
                    reference = chessai.util.reflection.Reference(text)
    ...
    def test_new_object_base(self):
        ...
        test_cases = [
            (
                'chessai.util.reflection_test._TestClass',
                None,
                [],
                {},
                0,
            ...
            (
                'chessai/util/reflection_test.py:_TestClass',
                None,
                [],
                {},
                0,
        ...
        for (i, test_case) in enumerate(test_cases):
            ...
            with self.subTest(msg = f"Case {i}:"):
                try:
                    actual = chessai.util.reflection.new_object(reference, *args, **kwargs)
                except Exception as ex:
                    if (error_substring is None):
                        self.fail(f"Unexpected error: '{str(ex)}'.")
